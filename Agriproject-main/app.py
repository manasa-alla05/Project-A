...
class RegisterForm(FlaskForm):
    ...
    submit = SubmitField("Register", render_kw={
        # "style": "background-color: #DEA22F; border-radius: 10px; color: rgb(12, 12, 12);",
        "class": "btn view rounded-pill"
    })
...
class LoginForm(FlaskForm):
    ...
    submit = SubmitField("Login", render_kw={
         "style": "background-color: #DEA22F; border-radius: 10px; color: rgb(12, 12, 12); align: center;",
        "class": "btn view rounded-pill"
    })
